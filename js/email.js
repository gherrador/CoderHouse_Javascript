export const enviarMail = (Orden) => {
  ...
  $('.table td img').css({"width": "6vw" ,"height": "4vw"})
  $('.table td').css({'font-size': '0.8rem','vertical-align': 'middle', 'text-align': 'center', 'width':'auto', 'height': '100%', 'border': '1px solid black'})
